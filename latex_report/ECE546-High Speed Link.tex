...
\begin{figure*}[htbp!]
	...
	\begin{minipage}[tb]{0.5\textwidth}
		...
		\end{tabular}
		\subcaption{Coefficient of FFE with 3Gbps input.}
	...
	\begin{minipage}[tb]{0.5\textwidth}
		...
		\end{tabular}
		\subcaption{Coefficient of FFE with 20Gbps input.}
		\label{table:20G_FFE_coeff} 
	\end{minipage}
	\caption{Coefficient of designated FFE.}
	\label{table:FFE_coeff}
\end{figure*}
...
\begin{table}[htbp!]
	...
	\caption{Sampling signal of received differential w/ FFE.}
\end{table}
