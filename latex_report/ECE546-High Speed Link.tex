...
In Fig.~\ref{fig:diff_pulse_response_w_FFE} and Table.~\ref{table:rx_diff_sample_DFE} shows the sampled differential channel response with FFE enabled. These channel responses can further be used to determine the 5-tap DFE. 
