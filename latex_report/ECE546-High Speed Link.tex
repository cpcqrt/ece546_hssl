...
\begin{figure*}
	...
	\begin{minipage}[h]{\textwidth}
		...
		\subcaption{Sampled signal of received differential w/o FFE.}
	\end{minipage}	
	\begin{minipage}[tb]{\textwidth}
		\centering	
		\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|}\hline
		...
		\subcaption{Sampled signal of received differential with FFE.}
	\end{minipage}
...
\begin{figure*}[htbp!]
	...
	\begin{minipage}[tb]{0.5\textwidth}
		...
		\subcaption{20Gb/s.}
	\end{minipage}%
	\label{fig:dfe_pulse_response}
	\caption{Pulse response after DFE.}
\end{figure*}
