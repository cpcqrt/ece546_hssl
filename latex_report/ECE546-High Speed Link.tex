...
\begin{figure*}[htbp!]
	...
	\begin{minipage}[tb]{0.5\textwidth}
		\centering	
		\includegraphics[width=\textheight]{./img/channel_response_eye_diagram/output_transient_response_3gbp.png}
		\subcaption{3 Gb/s. }
	\end{minipage}%	
	\begin{minipage}[tb]{0.5\textwidth}
		\centering	
		\includegraphics[width=\textheight]{./img/channel_response_eye_diagram/output_transient_response_20gbp.png}
		\subcaption{20 Gb/s. }
	\end{minipage}
